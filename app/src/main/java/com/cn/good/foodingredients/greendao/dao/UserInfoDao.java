package com.cn.good.foodingredients.greendao.dao;
...
public class UserInfoDao extends AbstractDao<UserInfo, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Ss = new Property(1, String.class, "ss", false, "SS");
    ...
    public UserInfo readEntity(Cursor cursor, int offset) {
        UserInfo entity = new UserInfo( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // ss
    ...
    public void readEntity(Cursor cursor, UserInfo entity, int offset) {
        ...
        entity.setSs(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
